    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/add/finish">Add Finished Products</a>
                        <a class="collapse-item" href="/add/raw">Add Raw Materials</a>
                        <a class="collapse-item" href="/add/storage">Add Storage</a>
                        <a class="collapse-item" href="/add/stockroom">Add Stock Room</a>
                    </div>
                    <div class="bg-white py-2 collapse-inner rounded">
            ...
            <li class="nav-item">
                ...
                @endif
                <div id="collapseTwoaddon" class="collapse" aria-labelledby="headingTwo"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">{{ $hpersonal->lastname }},
                                    {{ $hpersonal->firstname }} {{ $hpersonal->middlename }}</span>
