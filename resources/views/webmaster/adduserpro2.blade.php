...
@section('content')
    ...
    <hr>
    <div class="col-lg-12">
        <form method="POST" action="/adduser/pro2/save" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="form-group row mb-0">
                <div class="col-md-6 offset-md-4">
                    <input type="submit" class="btn btn-primary" onclick="return confirm('Save User?');" value="Save" name="submit">
                </div>
            </div>
        </form>
    </div>
